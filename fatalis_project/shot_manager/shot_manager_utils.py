...
from fatalis_project.shot_manager import shot_manager_panels as panels
...
def create_tab():
    ...
    left_tab_layout.addWidget(panels.TreePanel(True))
    left_tab_layout.addWidget(panels.TaskFilterPanel())
    ...
    mid_tab_layout.addWidget(panels.FilterBarPanel())
    mid_tab_layout.addWidget(panels.MainTablePanel())
    ...
    right_tab_layout.addWidget(panels.InfoPanel())
    right_tab_layout.addWidget(panels.LoadingPanel())
